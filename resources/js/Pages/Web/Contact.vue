...
<template>
    <Layout>
        ...
        <div class="space-y-4">
            <div class="my-6">
                <div
                    class="mx-auto container grid sm:grid-cols-2 items-center gap-16 bg-white  rounded-md">
                    <div>
                        ...
                        <div class="mt-12">
                            ...
                            <ul class="flex mt-3 space-x-4">
                                ...
                                <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <a target="_blank" href="https://api.whatsapp.com/send/?phone=+5218180534515&text=M%C3%A1s%20informaci%C3%B3n&type=phone_number">
                                        <i class="fab fa-whatsapp text-[#007BFF]"></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <form class="ml-auo space-y-4">
                        <input type='text' placeholder='Nombre'
                            class="w-full rounded-md py-2.5 px-4 border text-sm outline-primary" />
                        <input type='email' placeholder='Correo'
                            class="w-full rounded-md py-2.5 px-4 border text-sm outline-primary" />
                        <input type='text' placeholder='Asunto'
                            class="w-full rounded-md py-2.5 px-4 border text-sm outline-primary" />
                        <textarea placeholder='Mensaje' rows="6"
                            class="w-full rounded-md px-4 border text-sm pt-2.5 outline-primary"></textarea>
                        <button type='button'
                            class="text-white bg-primary hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Enviar</button>
                    </form>
                </div>
        </div>
    </div>
